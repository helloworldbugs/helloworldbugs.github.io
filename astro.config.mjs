...
// import { hyacinePlugin } from "@hyacine/astro"; // Disabled - Windows compatibility
...
// import Font from "vite-plugin-font"; // Disabled on Windows - cn-font-split requires native libs
...
export default defineConfig({
  ...
  integrations: [
    ...
    sitemap(),
    // hyacinePlugin(), // Disabled - Windows compatibility
    mermaid({
      theme: "default",
      autoTheme: true,
    }),
