...
![alt text](/assets/images/posts/WEB/Hexo从GitHub迁移到GitLab/image.png)

因为项目是私密的，不能让别人看到源文件，但是可以对所有人开放pages权限，这样就不影响他人阅读，但是无法拷贝项目源文件下来

- 关闭随机域

![alt text](/assets/images/posts/WEB/Hexo从GitHub迁移到GitLab/image-1.png)

如果不关闭这个，访问的时候域名末尾会自动加上一串随机字符，导致加载速度变慢、图片链接失效等情况

- 关闭分支保护

![alt text](/assets/images/posts/WEB/Hexo从GitHub迁移到GitLab/image-2.png)
