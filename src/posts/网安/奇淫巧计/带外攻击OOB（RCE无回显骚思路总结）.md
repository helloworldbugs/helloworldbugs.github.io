...
date: 2024-10-31
description: "向服务器提交一个 payload，而服务器响应给我们相关的 response 信息。大家都叫它带内攻击，这些理论的东西，我们简单理解就好，这里我们就理解成单挑通信的通道为带内攻击，也就是整个测试过程或者说是交互过程，中间没有其外部的服务器参与，只有自己和目标服务器，那么就叫带内。"
tags: []
---
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/001.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/002.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/003.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/004.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/005.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/006.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/007.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/008.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/009.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/010.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/011.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/012.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/013.png)

**查看burp模块，DNS隧道解析结果**

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/014.png)

**http隧道回显信息**

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/015.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/016.png)

#### **DNS记录中无回显**

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/017.png)

#### **http中有回显**

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/018.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/019.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/020.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/021.png)

**每行记录，再base64解密**

![拿到机器ifconfig命令执行记录，部分会乱码](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/022.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/023.png)

这种方式需要每条结果复制粘贴，比较麻烦，但回显结果还是准确的，可以看到ifconfig命令执行后的直接结果 

> **十六进制转换字符：**<http://www.bejson.com/convert/ox2str>

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/024.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/025.png)

![查看远程username名称结果为Butcher](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/026.png)

查看远程username名称结果为Butcher

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/027.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/028.png)

**执行成功**

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/029.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/030.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/031.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/032.png)

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/033.png)

第二串字符

![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/034.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/035.png)
...
![](/assets/images/posts/网安/奇淫巧计/带外攻击OOB（RCE无回显骚思路总结）/036.png)
