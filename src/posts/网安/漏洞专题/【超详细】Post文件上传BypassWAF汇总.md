...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/003-0.webp -->

### **文件描述双写混淆**

双写 `Content-Disposition`，一些 WAF 会取第二行，而实际 PHP 会获取第一行。

<!-- image: 【超详细】Post文件上传BypassWAF汇总/004-0.webp -->

另外针对 `Content-Disposition` 的双写混淆还有可以包括 `Content-Type`:

<!-- image: 【超详细】Post文件上传BypassWAF汇总/005-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/006-0.webp -->

**不带垃圾数据的情况**

<!-- image: 【超详细】Post文件上传BypassWAF汇总/007-0.webp -->

### **Boundary 混淆**

#### **构造双重 boundary**

<!-- image: 【超详细】Post文件上传BypassWAF汇总/008-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/009-0.webp -->

#### **空白 boundary**

<!-- image: 【超详细】Post文件上传BypassWAF汇总/010-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/011-0.webp -->

#### **boundary 中的逗号**

<!-- image: 【超详细】Post文件上传BypassWAF汇总/012-0.webp -->

事实上，在 PHP 中会将 Boundary 中的逗号作为分隔符，即 boundary 遇到逗号就结束。

只标识一个逗号也可以：

<!-- image: 【超详细】Post文件上传BypassWAF汇总/013-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/014-0.webp -->

<!-- image: 【超详细】Post文件上传BypassWAF汇总/015-0.webp -->

<!-- image: 【超详细】Post文件上传BypassWAF汇总/016-0.webp -->

这三个位置都可以。将其替换为 0x00 和 0x20 与之同理。

此外，将 0x00 放到参数名中也可以绕过：

<!-- image: 【超详细】Post文件上传BypassWAF汇总/017-0.webp -->

### **Boundary 混淆进阶**

boundary 的名称是可以前后加入任意内容的，WAF 如果严格按 boundary 去取，就会出现混淆。

<!-- image: 【超详细】Post文件上传BypassWAF汇总/018-0.webp -->

在双写 Content-Type 的混淆中，将第一个 Content-Type 和冒号部分填入了空格，实现绕过。

<!-- image: 【超详细】Post文件上传BypassWAF汇总/019-0.webp -->

Boundary 的取值混淆：  
<!-- image: 【超详细】Post文件上传BypassWAF汇总/020-0.webp -->

### **单双引号混合**

Content-Disposition 中的字段使用单引号、双引号进行混淆  
<!-- image: 【超详细】Post文件上传BypassWAF汇总/021-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/022-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/023-0.webp -->

其中的 param 就是 `name="f"`，当程序进入 `c < 0` 这个分支时，就会跳过当前 part 的上传流程。由于初始化时 `c = 0`，遇到 `[` 时，`c += 1`，遇到 `]` 时，`c -= 1`。因此，可以构造 `name="f]"`，即可让 `c = -1`。

<!-- image: 【超详细】Post文件上传BypassWAF汇总/024-0.webp -->

### **skip\_upload - 2**

在 PHP 源码中，有这样一段代码：

<!-- image: 【超详细】Post文件上传BypassWAF汇总/025-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/026-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/027-0.webp -->
...
<!-- image: 【超详细】Post文件上传BypassWAF汇总/028-0.webp -->
