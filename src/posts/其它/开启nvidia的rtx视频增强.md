...
![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image.png)
...
![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-2.png)
...
![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-3.png)
...
![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-6.png)

5. 点击右边的属性

![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-7.png)

6. 把这两个打开就可以了

![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-8.png)
...
![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-1.png)

打开任务管理器观察gpu的占用，你会发现开和没开是有明显的变动的，这得根据显卡的性能决定，性能越强的显卡占用越小，像我的3060ti开到最高（质量4）大概只占用个6%左右

没开前

![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-4.png)

开启后

![](/assets/images/posts/其它/开启nvidia的rtx视频增强/image-9.png)
